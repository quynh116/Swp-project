        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: relative;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul  class="nav_ketnoi navbar-nav m-auto">
                        <li class="nav-item">
                    ...
                    <form action="search" method="post" class="form-inline my-2 my-lg-0">
                        <div  class="input-group input-search input-group-sm">
                            <input style="width: 552px; margin-left: -300px;" name="txt" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Search...">
                        ...
                        <div class="header_Login-img">
                            <div><img  src="images/icon_login.png" alt="login"/></div>
                            <div class="header-Login header_Login-ht">
                                <p style="margin-top: 5px;" class="header-Login-p header_Login-modal"><a  href="#profile" >Tài khoản của tôi</a></p>
                        ...
                        <a class="btn-carc btn btn-success btn-sm ml-3" href="show">
